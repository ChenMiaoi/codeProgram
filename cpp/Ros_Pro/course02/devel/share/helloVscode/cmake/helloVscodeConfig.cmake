...
if("TRUE" STREQUAL "TRUE")
  set(helloVscode_SOURCE_PREFIX /home/zack/Ros_Pro/course02/src/helloVscode)
  set(helloVscode_DEVEL_PREFIX /home/zack/Ros_Pro/course02/devel)
  ...
  set(helloVscode_INSTALL_PREFIX /home/zack/Ros_Pro/course02/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'helloVscode' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zack/Ros_Pro/course02/src/helloVscode/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zack/Ros_Pro/course02/devel/lib;/home/zack/Ros_Pro/course02/devel/lib;/opt/ros/noetic/lib)
