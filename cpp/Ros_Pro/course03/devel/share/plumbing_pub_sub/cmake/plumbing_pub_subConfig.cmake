...
if("TRUE" STREQUAL "TRUE")
  set(plumbing_pub_sub_SOURCE_PREFIX /home/zack/Ros_Pro/course03/src/plumbing_pub_sub)
  set(plumbing_pub_sub_DEVEL_PREFIX /home/zack/Ros_Pro/course03/devel)
  ...
  set(plumbing_pub_sub_INSTALL_PREFIX /home/zack/Ros_Pro/course03/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'zack <zack@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'plumbing_pub_sub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zack/Ros_Pro/course03/src/plumbing_pub_sub/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zack/Ros_Pro/course03/devel/lib;/home/zack/Ros_Pro/course03/devel/lib;/opt/ros/noetic/lib)
